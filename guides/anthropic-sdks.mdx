...
```json
{
  "env": {
    ...
    "ANTHROPIC_MODEL": "kimi-k2.6:dev",
    "ANTHROPIC_DEFAULT_SONNET_MODEL": "kimi-k2.6:dev",
    "ANTHROPIC_DEFAULT_OPUS_MODEL": "kimi-k2.7-code:dev",
    "ANTHROPIC_DEFAULT_HAIKU_MODEL": "deepseek-v4-flash:dev"
  }
}
```
