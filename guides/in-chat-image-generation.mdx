...
<div style="border-radius: 16px !important; overflow: hidden !important;">
  <img
    className="block dark:hidden"
    src="/images/st-example.png"
    alt="SillyTavern in‑chat image generation"
    style="display: block; width: 100%; height: auto; border-radius: 16px !important;"
  />
  <img
