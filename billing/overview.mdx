# <Icon icon="credit-card" /> Billing & Credits Overview
...
## <Icon icon="compass" /> Quick Navigation
...
<Columns cols={2}>
  <Card title="Subscriptions" icon="repeat" color="#8B5CF6">
    ...
    **Ideal for:**
    - <Icon icon="check" /> Regular, consistent usage
    - <Icon icon="check" /> Predictable monthly costs
    - <Icon icon="check" /> Access to premium/ultimate models
    - <Icon icon="check" /> Higher rate limits and more features
  ...
  <Card title="Pay-as-You-Go" icon="wallet" color="#10B981">
    ...
    **Ideal for:**
    - <Icon icon="check" /> Irregular or unpredictable usage
    - <Icon icon="check" /> One-time projects
    - <Icon icon="check" /> Testing and experimentation
    - <Icon icon="check" /> Supplementing subscription credits
...
<Columns cols={2}>
  <Card title="Dashboard" icon="layout-dashboard" href="https://playground.electronhub.ai/console">
