...
<Columns cols={2}>
  ...
  <Card title="Coding Plan (DevPass)" icon="terminal" href="/billing/coding-plan">
    Flat-rate plan for coding agents and CLI tools
  </Card>
...
<Info>
  Building with coding agents or CLI tools? There's a third option: the **[Coding Plan (DevPass)](/billing/coding-plan)** — a flat-rate plan ($5 or $20/month) with a dedicated `ek-dev-` key and unmetered access to a curated set of coding models. It never consumes credits and stacks with any other plan.
</Info>
