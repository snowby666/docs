...
| Standard · 1× | `qwen3.8-27b:dev` | <Icon src="/images/modality-text.svg" size={18} /> <Icon src="/images/modality-image.svg" size={18} /> → <Icon src="/images/modality-text.svg" size={18} /> | 262K · BF16 | Qwen3.8 27B; vision, native tools, thinking + prompt cache |
