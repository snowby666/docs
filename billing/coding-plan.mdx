...
| **Flash** | 0.5× | `glm-4.7-flash:dev` | 200K | Efficient 30B-class agentic coding & tool collaboration |
...
| **Heavy** | 2× | `kimi-k2.7-code:dev` | 262K | Coding-focused Kimi K2.7; long-horizon agentic tasks (vision + tools) |
| **Heavy** | 2× | `glm-5.2:dev` | 262K | Repo-scale agentic software engineering |
