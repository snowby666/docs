...
description: 'Flat monthly plan for coding agents. Unlimited tokens, no credits.'
icon: 'terminal'
---

The **Coding Plan** (DevPass) is a flat monthly plan for coding agents and CLIs — Claude Code, Cursor, Cline, Roo Code, or any OpenAI- or Anthropic-compatible tool.

A dedicated `ek-dev-` key. Unlimited tokens. No credits. Independent of every other Electron Hub plan.
...
| Heavy · 2× | `glm-5.3:dev` | <Icon src="/images/modality-text.svg" size={18} /> → <Icon src="/images/modality-text.svg" size={18} /> | 262K · FP8 | 744B-A40B. Text-only. Same GLM-5.2 base, post-trained. Stronger complex coding and long-horizon agents. |
