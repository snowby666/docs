...
| Flash · 0.5× | `deepseek-v4-flash:dev` | <Icon src="/images/modality-text.svg" size={18} /> → <Icon src="/images/modality-text.svg" size={18} /> | 1M · NVFP4 (FP4 MoE + FP8 attn) | Fast MoE (13B active); high-throughput coding |
...
| Standard · 1× | `qwen3.6-27b:dev` | <Icon src="/images/modality-text.svg" size={18} /> <Icon src="/images/modality-image.svg" size={18} /> → <Icon src="/images/modality-text.svg" size={18} /> | 262K · BF16 | Repo-level coding & reasoning |
...
| Heavy · 2× | `kimi-k2.7-code:dev` | <Icon src="/images/modality-text.svg" size={18} /> <Icon src="/images/modality-image.svg" size={18} /> → <Icon src="/images/modality-text.svg" size={18} /> | 262K · INT4 (MoE) + BF16 | Long-horizon coding agents (vision + tools) |
