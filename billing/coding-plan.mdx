...
|---|---|---|---|---|
| Flash · 0.5× | `glm-5.3-flash:dev` | Text, image | 1M · FP8 | 320B-A18B. Native multimodal (text, image, video). Hybrid sparse and linear attention. |
| Flash · 0.5× | `deepseek-v4-flash:dev` | Text | 1M · NVFP4 (FP4 MoE + FP8 attn) | Preview Flash. High-throughput coding. |
| Flash · 0.5× | `deepseek-v4-flash-0731:dev` | Text | 400K · FP8 + FP4 (MXFP4 MoE) | V4 Flash GA. 13B active. Stronger agent and coding work. |
| Flash · 0.5× | `mimo-v2.5:dev` | Text, image | 1M · FP8 | Omnimodal agentic coding. |
| Standard · 1× | `qwen3.6-27b:dev` | Text, image | 262K · BF16 | Repo-level coding. |
| Standard · 1× | `qwen3.8-27b:dev` | Text, image | 262K · BF16 | Multimodal agentic coding. |
| Standard · 1× | `minimax-m2.7:dev` | Text | 180K · FP8 | Agentic productivity and multi-agent work. |
| Standard · 1× | `kimi-k2.6:dev` | Text | 240K · INT4 (MoE) + BF16 | Long-horizon coding, UI/UX, agent swarms. |
| Heavy · 2× | `kimi-k2.7-code:dev` | Text | 262K · INT4 (MoE) + BF16 | Long-horizon coding agents. |
| Heavy · 2× | `glm-5.3:dev` | Text | 1M · FP8 | 744B-A40B. Text-only. Same GLM-5.2 base, post-trained. Stronger complex coding and long-horizon agents. |
