---
title: 'Model Types & Access'
description: 'Understanding which models you can access and how they are billed'
icon: 'brain'
---
...
<Card title="Popular Premium Models" icon="wand-2" color="#8B5CF6">
  - `gpt-4`
  - `o1`, `o1-low`, `o1-high`
