...
<Accordion title="Why can't I use a premium or ultimate model?">
  ...
  <Tip>
    ...
    - Upgrade through **Console → Billing → Subscription** (Creem, lava.top, or Ko-fi) to access premium/ultimate models
  </Tip>
</Accordion>
...
<Accordion title="Subscription Refunds">
  <Info>
    Subscriptions are managed through **Creem**, **lava.top**, or **Ko-fi**, depending on which you subscribed with (check Billing → Subscription to see your provider). Creem subscribers can cancel anytime from the **Manage billing** portal. lava.top subscribers cancel from Billing → Subscription (period-end only). Refund requests for Creem, lava.top, or Ko-fi should go through that provider's support.
  </Info>
</Accordion>
