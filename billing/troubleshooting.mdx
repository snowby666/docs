...
<Accordion title="Subscription Refunds">
  <Info>
    Monthly subscriptions are managed through **Creem** or **Ko-fi**, depending on which you subscribed with (check Billing → Subscription to see your provider). Creem subscribers can cancel anytime from the **Manage billing** portal; refund requests for Creem should be made through Creem's support. Refund requests for Ko-fi subscriptions should be made through Ko-fi's refund system.
  </Info>
</Accordion>
