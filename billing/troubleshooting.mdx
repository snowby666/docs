...
<Accordion title="Why can't I use a premium or ultimate model?">
  ...
  <Tip>
    ...
    - Upgrade through Ko-fi to access premium/ultimate models
  </Tip>
</Accordion>
...
<Accordion title="Subscription Refunds">
  <Info>
    Monthly subscriptions are managed through Ko-fi. Refund requests for subscriptions should be made through Ko-fi's refund system.
  </Info>
</Accordion>
