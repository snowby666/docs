...
<ParamField body="reasoning" type="object">
  NanoGPT-style reasoning configuration. Supports:
...
- **Cost.** Reasoning tokens count as output tokens (per [NanoGPT's extended-thinking docs](https://docs.nano-gpt.com/api-reference/miscellaneous/extended-thinking)). Higher `reasoning_effort` and `/v1thinking/` requests typically have higher `completion_tokens` and cost.
