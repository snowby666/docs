...
<ResponseField name="400" type="error">
  **Bad Request** &mdash; the request body is missing `proxy_key` or violates the length constraint (`1 <= len <= 256`). Returned as the standard [error envelope](/getting-started/errors) (`{"error": {...}}`).
</ResponseField>
