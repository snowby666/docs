...
<CardGroup cols={1}>
  <Card title="Quick Start" icon="pen-to-square" href="docs/en/quickstart">
...
<CardGroup cols={2}>
  ...
  <Card title="Reference APIs" icon="code" href="https://mintlify.co/docs/api-playground/openapi">
