---
title: Electron Hub API Platform Documentation
description: 'Monica API Platform (also known as Monica Open API) is a unified API platform that integrates AI APIs for chat, image generation, image processing and more.'
---
