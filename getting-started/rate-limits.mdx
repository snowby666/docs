...
| **Starter**       | 100            | Experimental/Preview models only |
| **Plus**          | 200            | Experimental/Preview models only |
| **Core**          | 300            | Experimental/Preview models only |
| **Pro**           | 500            | Experimental/Preview models only |
| **Business**      | 1000           | Experimental/Preview models only |
| **Enterprise**    | 2000           | Experimental/Preview models only |
