...
`ek-dev-` keys have **no RPM limit**. They allow a set number of parallel requests instead (2 on Lite, 5 on Turbo) plus a daily fair-use allowance — see the [Coding Plan docs](/billing/coding-plan#fair-use).
