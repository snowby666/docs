...
| ----------------- | -------------- | --------------- |
| **Free**          | 50             | Experimental/Preview/Image models only |
| **Starter**       | 100            | Experimental/Preview/Image models only |
| **Plus**          | 200            | Experimental/Preview/Image models only |
| **Core**          | 300            | Experimental/Preview/Image models only |
| **Pro**           | 500            | Experimental/Preview/Image models only |
| **Business**      | 1000           | Experimental/Preview/Image models only |
| **Enterprise**    | 2000           | Experimental/Preview/Image models only |
