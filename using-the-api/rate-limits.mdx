---
title: "Rate Limits"
description: "Understand Electron Hub API rate limits and learn how to optimize your usage across different subscription plans."
---
...
<Tip>
  You can check your current rate limits and usage anytime in the [API Keys section](https://playground.electronhub.top/console) of your dashboard.
</Tip>
...
| **Plus**          | 20 RPM                    | Growing projects        |
| **Pro**           | 40 RPM                    | Production applications |
...
Use the [dashboard](https://playground.electronhub.top/console) to:
...
1. Visit your [dashboard](https://playground.electronhub.top/console)
